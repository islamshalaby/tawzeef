					...
					<div class="login-form style-2">
						...
						<div class="tab-content nav p-b30 tab">
							<div id="login" class="tab-pane active ">
								<form class=" dez-form p-b30" method="POST" action="{{ route('login.user') }}">
                                    @csrf
								...
								<div class="dz-social clearfix">
									<h5 class="form-title m-t5 pull-left">{{ __('messages.register') }}</h5>
									<ul class="dez-social-icon dez-border pull-right dez-social-icon-lg text-white">
										<li><a class="fa fa-facebook  fb-btn" href="/login/facebook" target="bank"></a></li>
										...
										<li><a class="fa fa-google-plus  gplus-btn" href="/login/google" target="bank"></a></li>
									</ul>
