    ...
    <div class="col-lg-12 col-12 layout-spacing">
        ...
        <form action="" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group mb-4">
                ...
                <input required type="text" name="name_ar" class="form-control" id="name_ar" placeholder="{{ __('messages.company_name_ar') }}" value="" >
            </div>
            <div class="form-group mb-4">
                <label for="name_en">{{ __('messages.company_name_en') }}</label>
                <input required type="text" name="name_en" class="form-control" id="name_en" placeholder="{{ __('messages.company_name_en') }}" value="" >
            </div>
            <div class="form-group mb-4">
                <label for="email">{{ __('messages.email') }}</label>
                <input required type="email" name="email" class="form-control" id="email" placeholder="{{ __('messages.email') }}" value="" >
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group mb-4">
                ...
                <input required type="text" name="website" class="form-control" id="website" placeholder="{{ __('messages.website') }}" value="" >
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group mb-4">
                ...
                <textarea required class="form-control" name="description_ar" id="description_ar"></textarea>
            </div>
            <div class="form-group mb-4">
                <label for="description_en">{{ __('messages.description_en') }}</label>
                <textarea required class="form-control" name="description_en" id="description_en"></textarea>
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group mb-4">
                ...
                <input required class="form-control" type="text" name="address_en" id="address_en">
            </div>                       
            <div class="form-group mb-4">
                <label for="facebook">{{ __('messages.facebook') }}</label>
                <input required class="form-control" type="text" name="facebook" id="facebook">
            </div>                            
            <div class="form-group mb-4">
                <label for="twitter">{{ __('messages.twitter') }}</label>
                <input required class="form-control" type="text" name="twitter" id="twitter">
            </div>                            
            <div class="form-group mb-4">
                <label for="linkedin">{{ __('messages.linkedin') }}</label>
                <input required class="form-control" type="text" name="linkedin" id="linkedin">
            </div>                            
            <div class="form-group mb-4">
                <label for="youtube">{{ __('messages.youtube') }}</label>
                <input required class="form-control" type="text" name="youtube" id="youtube">
            </div>                            
